                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="short_desc" id="general" cols="30" rows="10" class="form-control" >{!!old('short_desc',@$edit->short_desc)!!}</textarea>
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="long_desc" id="general" cols="30" rows="10" class="form-control" >{!!old('long_desc',@$edit->long_desc)!!}</textarea>
